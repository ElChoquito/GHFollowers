...
private extension FavoritesListViewController {
    func configureViewController() {
        ...
        title = NSLocalizedString("favoriteListViewController.title")
    ...
    func updateUI(with favorites: [Follower]) {
        if favorites.isEmpty {
            self.showEmptyStateView(with: "favoriteListViewController.emptyStateView.message", in: self.view)
        } else {
...
extension FavoritesListViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        PersistenceManager.updateWith(favorite: favorites[indexPath.row], actionType: .remove) { [weak self] (error) in
            ...
            self.presentGFAlertOnMainThread(title: "favoriteListViewController.removeUserError.alert.title", message: error.rawValue)
        }
    }
}
